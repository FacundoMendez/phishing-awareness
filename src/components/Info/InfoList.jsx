...
const InfoList = () => {
    ...
    const list = [
      ...
      },
      {
          ...
          description: "Las contraseñas seguras y únicas son esenciales para proteger tus cuentas en línea contra el phishing. Usa contraseñas fuertes y únicas para cada cuenta y cámbialas regularmente. Considera el uso de un administrador de contraseñas para generar contraseñas aleatorias y almacenarlas de manera segura.",
          description2: "",
          description3: "",
      },
      {
